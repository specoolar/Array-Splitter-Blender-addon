...
def calc_curve_length(curve,context):
    ...
    for edge in context.active_object.data.edges:
        v1 = context.active_object.data.vertices[edge.vertices[0]].co
        v2 = context.active_object.data.vertices[edge.vertices[1]].co
        curve_length += (v1 - v2).length
    
    active_data = context.active_object.data
        ...
        for obj in objs:
            ...
            for mod in obj.modifiers:
                ...
                while True:
                    ...
                    copy_transform(scene.objects.active, offset_obj.matrix_local)
                    scene.objects.active.parent = parent_obj
                    parent_obj = scene.objects.active
                    ...
                    if   mod.fit_type == 'FIXED_COUNT':
                        ...
                        if length_counter>=tar_length:
                            scene.objects.active = parent_obj.parent
                ...
                if mod.start_cap:
                    ...
                    bpy.ops.object.duplicate(linked = self.linked)
                    copy_transform(scene.objects.active, offset_obj.matrix_local.inverted_safe())
                    scene.objects.active.parent = obj
                    generated_objs.append(scene.objects.active)
            ...
            if obj.parent:
                ...
                scene.objects.active = obj.parent
                bpy.ops.object.parent_set(keep_transform = True)
            else:
